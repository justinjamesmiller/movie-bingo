  ...
  return (
    <ModalShell onClose={onClose}>
      <div className="modal-content help-modal-content">
        ...
        <p className="hint">
          Hosts can update the movie or TV show by tapping its title during a game. An IMDb-selected title refreshes the
          visual theme and poster treatment, while the current board and trope pool stay unchanged.
        </p>
        ...
        <ul className="help-list">
          ...
          <li>
            ...
            tracked as correct only if that trope is later accepted.
          </li>
        </ul>
        ...
        <ul className="help-list">
          ...
          <li>
            ...
            if it&apos;s not on your own board), or to propose replacing it while it has not been accepted.
          </li>
        </ul>
        ...
        <p className="hint">
          ...
          tropes, wager management, activity history, board swapping, and session lifetime. Those tools are grouped into
          Explore &amp; Stats, My Tools, and Host Settings so only one group is open at a time.
        </p>
        ...
        <h4>🧑‍🎤 Avatars</h4>
        <p className="hint">
          Tap your own name in the Players list to change your name and emoji avatar. It shows up in claim prompts and
          the final recap so everyone can tell you apart at a glance.
        </p>
        ...
        <p className="hint">
          The speaker icon in the header mutes/unmutes notification sounds. A visible prompt and browser-tab alert also
          appear when the group needs your answer; iPhone and iPad browsers do not reliably support webpage vibration.
          If your connection drops, a red banner appears at the top of the screen so you know to check your network.
        </p>
