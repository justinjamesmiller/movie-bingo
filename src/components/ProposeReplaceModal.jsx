  ...
  return (
    <div className="modal">
      <div className="modal-content">
        ...
        <p className="hint">
          The new trope can come from any genre/sub-genre in play -- not just this game's own.
        </p>
        ...
        <div className="claim-vote-buttons cancel-claim-btn">
          <button className="btn agree" onClick={() => onConfirm(genre, subgenre)}>👍 Propose it</button>
          <button className="btn disagree" onClick={onCancel}>👎 Never mind</button>
        </div>
      </div>
    </div>
  );
